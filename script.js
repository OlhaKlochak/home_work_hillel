...
if (!isNaN(year) && year >= 0) {
    // Перевірка на останню цифру року, щоб визначити правильне слово
    let lastyear = year % 10;
    let lastTwoDigits = year;
    let result;

    // Визначення правильного слова для року в залежності від останньої цифри
    ...
    // Якщо введене значення не є числом або є від'ємним
